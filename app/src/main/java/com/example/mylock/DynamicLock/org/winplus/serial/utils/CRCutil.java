...
public class CRCutil {
	...
	public static void main(String[] args) {
		...
		int crc = CRCutil.calcCrc16(new byte[] { 0x02, 0x05, 0x00, 0x03, (byte) 0xff, 0x00 });
		System.out.println(UB(crc));
		System.out.println(LB(crc));
	}
	/**
	 * 取高八位
	 * @param num
