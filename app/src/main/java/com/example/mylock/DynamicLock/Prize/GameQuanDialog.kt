...
class GameQuanDialog(private val mcontext: Context?) {
    ...
    fun create(): GameQuanDialog {
        ...
        tv_dialog_game_quan= contentview!!.findViewById(R.id.tv_dialog_game_quan) as TextView?
        tv_dialog_game_quan_name= contentview!!.findViewById(R.id.tv_dialog_game_quan_name) as TextView?
        tv_dialog_game_quan_img= contentview!!.findViewById(R.id.tv_dialog_game_quan_img) as ImageView?
        tv_dialog_game_quan_qrcode= contentview!!.findViewById(R.id.tv_dialog_game_quan_qrcode) as ImageView?
