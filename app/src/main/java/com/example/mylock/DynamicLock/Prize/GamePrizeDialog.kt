...
class GamePrizeDialog(private val mcontext: Context?) {
    ...
    fun create(): GamePrizeDialog {
        ...
        tv_dialog_game_prize_index= contentview!!.findViewById(R.id.tv_dialog_game_prize_index) as TextView?
        tv_dialog_game_prize_name= contentview!!.findViewById(R.id.tv_dialog_game_prize_name) as TextView?
        tv_dialog_game_prize_img= contentview!!.findViewById(R.id.tv_dialog_game_prize_img) as ImageView?
